    ...
    def convert(self):
        ...
        if exponent_input <= 369 and exponent_input >= -398:
            ...
            if sign_bit == '1':
                ...
                output_binary = "1 11110 00000000 00000000000000000000000000000000000000000000000000"
                hexed = hex_to_binary(complete_binary)
                ...
                output_binary = "0 11110 00000000 00000000000000000000000000000000000000000000000000"
                hexed = hex_to_binary(complete_binary)
